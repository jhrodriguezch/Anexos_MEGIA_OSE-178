...
arch_name = 'C_NVD_25027330.csv'
# ------------ CAMBIAR NOMBRE DE ENTRADA --------------------------------------
Nombre_Archivo = 'N_PENONSITO'
# -----------------------------------------------------------------------------


os.chdir('/home/girehe2o/Escritorio/MEGIA/M1D/NVL2LOI/')
...
os.chdir('/home/girehe2o/Escritorio/MEGIA/M1D/NVL2LOI/Resultados')
arch = open('Q_R_' + arch_name[:-4].upper() + '_cal.loi', 'w')
...
arch = open('Q_R_' + arch_name[:-4].upper() + '.loi', 'w')
arch.write('# ' + Nombre_Archivo + '\n')
arch.write('# Temps (s) Debit\n')
arch.write('         S\n')
arch.write(' ')
